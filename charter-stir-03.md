...
The Working Group will define a means to associate a PASSporT with an identifier representing the entity holding the right to use an assigned telephone number, and will document the privacy implications of exposing such an association, consistent with the guidance in RFC 6973.
